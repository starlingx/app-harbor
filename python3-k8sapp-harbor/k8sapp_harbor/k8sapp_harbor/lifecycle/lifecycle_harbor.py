...
class HarborAppLifecycleOperator(base.AppLifecycleOperator):
    def app_lifecycle_actions(self, context, conductor_obj, app_op, app, hook_info):
        ...
        super(HarborAppLifecycleOperator, self).app_lifecycle_actions(
    ...
    def post_apply(self, app_op, app, hook_info):
        ...
        component_constant = app_constants.HELM_COMPONENT_LABEL_HARBOR
        ...
        namespace = client_core.read_namespace(app_constants.HELM_NS_HARBOR)
    ...
    def _get_helm_user_overrides(self, dbapi_instance, db_app_id):
        try:
            overrides = dbapi_instance.helm_override_get(
                app_id=db_app_id,
                name=app_constants.HELM_CHART_HARBOR,
    ...
    def _delete_harbor_pods(self, app_op, client_core):
        # pod list
        system_pods = client_core.list_namespaced_pod(app_constants.HELM_NS_HARBOR)
